...
release = subprocess.check_output(['node', '-e', 'console.log(require("../package.json").version)']).decode('utf-8')
...
htmlhelp_basename = 'F5Mystiquedoc'
...
latex_documents = [
    (master_doc, 'F5Mystique.tex', u'F5 Mystique Documentation',
...
man_pages = [
    (master_doc, 'f5mystique', u'F5 Mystique Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5Mystique', u'F5 Mystique Documentation',
     author, 'F5Mystique', 'One line description of project.',
     'Miscellaneous'),
]
