...
.. list-table::
      ...
      * - 1.22
        - BIG-IP FAST **v1.22** can be found `here <https://github.com/F5Networks/f5-appsvcs-templates/releases>`_
        - 11-15-22

      * - 1.21
        - BIG-IP FAST **v1.21** can be found `here <https://github.com/F5Networks/f5-appsvcs-templates/releases>`_
        - 10-04-22
