...
| Use the following command to zip your template ``fast packageTemplateSet <templateSetPath>``
...
#. To add this to the system, the template can be placed into a zip file. From the command line:  ``fast packageTemplateSet hello.zip hello.mst``
...
FAST also allows specification of custom types using JSON schema.
