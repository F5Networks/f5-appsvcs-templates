...
In certain instances, running BIG-IP version 16.1 with FAST version 1.15.0, and performing a reboot may result in the following error::
...
The resolution is to upgrade to FAST version 1.16.0
