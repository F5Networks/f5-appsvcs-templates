...
function createWorker() {
    ...
    worker.tracer.startSpan({
        requestId: 0,
        message: 'unit_test_start'
    });
    worker.setDeviceInfo(0);
...
describe('fastWorker tests', function () {
    ...
    describe('worker methods', function () {
        ...
        it('hydrateSchema - enumFromBigip is a string', function () {
            ...
            return worker.hydrateSchema(tmpl, 0, false)
                .then((schema) => {
                    console.log(schema);
        ...
        it('bigipDependencies', function () {
            ...
            const checkTmplDeps = (yamltext) => {
                ...
                return Promise.resolve()
                    ...
                    .then(tmpl => worker.checkDependencies(tmpl, 0, false))
                    .then(() => retTmpl);
            };
