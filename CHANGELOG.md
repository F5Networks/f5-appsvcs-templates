...
* Include _links property to FAST REST response to make them HAL JSON.
...
# 1.16.0
## Added
* bigip-fast-templates: Existing WAF Policies can be selected instead of a new one Generated by FAST (issue [#87](https://github.com/F5Networks/f5-appsvcs-templates/issues/87))
